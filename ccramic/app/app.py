            ...
            dbc.Tab(label='Image Annotation', tab_id='image-annotation', active_label_style={"color": "#FB79B3"},
                ...
                children=[
                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                        ...
                        style={"display": "inline-block"}),html.Div("Configure Inputs")],
                        style={"margin-top": "-5px", "margin-bottom": "10px"}),
                                   id="inputs-offcanvas-button",
                                   color=None, n_clicks=0,
                                   style={"margin-top": "10px"}),]), width=2),
                                 dbc.Col([html.H5("Channel selection", style={"margin-top": "17.5px"}),
                                          dcc.Dropdown(id='image_layers', multi=True,
                                     style={"margin-top": "10px"})],
                                         width=10, style={"display": "inline-block"})]),
                        dbc.Row([dbc.Col(width=2),
                        dbc.Col([html.Div([dcc.Slider(50, 150, 5, value=100, id='annotation-canvas-size',
                                   marks={50: 'small', 100: 'default',
                                          150: 'large'})], style={"margin-top": "15px", "width": "100%"})], width=6)]),
                        dbc.Row([dbc.Col([html.Div([dbc.Button(children=html.Span([html.Div("Fullscreen"),
                                ...
                                dbc.Button("Auto-fit canvas", id="autosize-canvas", style={"margin-left": "10px",
                                    "margin-top": "5px", "height": "100%"})])], width=3),
                                 dbc.Col(html.Div(style={"margin-left": "20px", "margin-right": "10px",
                                                                    "margin-top": "10px", "height": "100%",
                                                  "width": "150%"},
                                          id="bound-shower"), width=5, style={"float": "right"}),
                                 dbc.Col([dcc.Input(id="set-x-auto-bound", type="number", value=None,
                                  ...
                                  dbc.Button("Set", id="activate-coord",
                                             style={"margin-left": "15px",
                                                    "margin-right": "10px"})], width=4, style={"float": "right"})
                                 ]),
                        html.Br(),
                        html.Div([render_default_annotation_canvas(input_id="annotation_canvas")],
                                 style={"margin-top": "-22px", "display": "flex", "justifyContent": "center"},
                        ...
                        dbc.Col([
                            html.Div(
                                [html.H5("Channel Modification",
                                         style={'width': '75%', 'display': 'inline-block', "margin-top": "10px",
                                                "margin-left": "10px"}),
                                ...
                                style={"display": "flex"}), id="show-pixel-hist",
                                color="light", n_clicks=0, style={"margin-top": "10px", "display": "flex",
                                "margin-left": "20px"}),
                                ...
                                id='pixel-intensity-slider', tooltip={"placement": "top", "always_visible": True})],
                                 ...
                                 html.Br(),
                                 dcc.Checklist(options=[' apply/refresh filter'], value=[], id="bool-apply-filter"),
                                ...
                                dbc.Tab(label="Region/Annotation",
                                tab_id='region-config-tab',
                                children=[dbc.Button("Add region annotation",id="region-annotation",
                                style={"margin-top": "5px", "height": "100%"}, disabled=True),
                                dbc.Modal(children=dbc.ModalBody(
                                ...
                                html.Br(),
                                html.Br(),
                                dbc.Button("Show/hide region statistics",
                                id="compute-region-statistics", className="mb-3", color="primary", n_clicks=0),
                                html.Br(),
                                ...
                                id="download-collapse", is_open=False), style={"minHeight": "100px"}),
                                 ...
                                 html.Div([dag.AgGrid(
                                     ...
                                     })], style={"margin-bottom": "-30px", "width": "90%", "margin-left": "12.5px"}),
                                 dbc.Button(
                                     ...
                                     id="set-sort",
                                     color=None, n_clicks=0,
                                     style={"margin-top": "-250px", "display": "inline-block"}),
                                 ],
