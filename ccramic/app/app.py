                ...
                children=[
                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                        ...
                        style={"margin-top": "-5px", "margin-bottom": "10px"}),
                                 ...
                                 dbc.Col([html.Div([html.H5("Channel selection", style={"margin-top": "12.5px",
                                                                                        "float": "left"}),
                        ...
                        dbc.Col([
                            html.Div(
                                ...
                                daq.ToggleSwitch(label='Toggle scalebar', id='toggle-canvas-scalebar',
                                    ...
                                    html.Div([html.H6("Scalebar value", style={'width': '150%'}),
                                dcc.Input(id="custom-scale-val", type="number", value=None,
                                    style={"width": "60%", "margin-left": "30px"})],
                                    style={"display": "block"}),
                                    html.Div([html.H6("μm/pixel", style={'width': '75%', 'margin-left': '30px'}),
