                ...
                children=[
                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                        ...
                        dcc.Dropdown(id='image_layers', multi=True,
                                     style={'width': '87.5%', 'height': '85%', 'display': 'inline-block',
                                ...
                                [html.H5("Channel Modification",
                                 ...
                                 dbc.Offcanvas(id="blend-config-offcanvas", title="Canvas configuration",
                                         ...
                                         html.Div([daq.ToggleSwitch(label='Toggle legend',
                                                                    id='toggle-canvas-annotations',
                                                                    labelPosition='bottom',
                                                                    value=True, color="blue", style={"width": "75%",
                                                                                                     "margin-left": "-15px"}),
                                                   html.Div(
                                                       [html.H6("Set custom scalebar value", style={'width': '110%'}),
                                         ...
                                         dcc.Slider(0, 100, 2.5, value=100, id='mask-blending-slider',
                                                    marks={0: '0%', 25: '25%',
                                                           50: '50%', 75: '75%', 100: '100%'}),
                                         html.Div([html.Div([daq.ToggleSwitch(label='Apply mask', id='apply-mask',
                                                             ...
                                                             html.Abbr(
                                                                 dcc.Checklist(options=[' add boundary'], value=[],
