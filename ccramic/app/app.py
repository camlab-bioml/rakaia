            ...
            dbc.Tab(label='Image Annotation', tab_id='image-annotation', active_label_style={"color": "#FB79B3"},
                ...
                children=[
                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                        dbc.Button(children=html.Span([html.I(className="fa-solid fa-solid fa-solid fa-file-export",
                                                              style={"display": "inline-block"}),
                                                       html.Div("Configure Inputs"),
                                                       ], style={"width": "100vw", "margin-top": "-5px",
                                                                 "margin-bottom": "10px"}),
                                   id="inputs-offcanvas-button",
                                   color=None, n_clicks=0,
                                   style={"margin-top": "10px"}),
                        html.H5("Channel options", style={'width': '65%', 'display': 'inline-block',
                                                               'margin-left': '30px', "margin-top": "0px"}),
                        dcc.Dropdown(id='image_layers', multi=True,
                                     style={'width': '92.5%', 'height': '85%', 'display': 'inline-block',
                                            'margin-left': '85px', 'margin-top': '-10px'}),
                        html.Div([dcc.Slider(50, 150, 5, value=100, id='annotation-canvas-size',
                                   marks={50: 'small', 100: 'default',
                                          150: 'large'})], style={"width": "50%", "margin-top": "5px",
                                                                  "margin-left": "145px"}),
                    ...
                    html.Div(dbc.Collapse(
                        ...
                        html.Div(
                            [html.H5("Channel Modification",
                                style={'width': '75%', 'display': 'inline-block', "margin-top": "12.5px"}),
                        html.Abbr("\u2753", title="Select a channel in the current blend to \nchange colour, "
                            ...
                            dcc.Dropdown(id='images_in_blend', multi=False),
                             ...
                             html.Div(dbc.Collapse(html.Div([html.H6("Pixel histogram", style={'width': '75%'}),
                                ...
                                xaxis=go.XAxis(showticklabels=False), yaxis=go.YAxis(showticklabels=False),
                             ...
                             dbc.Button(
                                 children=html.Span([html.I(className="fa-solid fa-gears",
                                                     ...
                                                     html.Div("Advanced blend options"),
                                                     ], style={"width": "100vw", "margin-top": "-5px",
                                 ...
                                 style={"margin-top": "10px"}),
                             html.Br(),
                             dbc.Offcanvas(id="blend-config-offcanvas", title="Canvas configuration",
                             ...
                             is_open=False, children=[
                                     ...
                                     dcc.Loading(dcc.Dropdown(id='mask-options', multi=False, options=[],
                                                                               style={'width': '100%',
                             ...
                             id="add-mask-boundary", style={"margin-left": "35px", "margin-top": "10px"}),
                            ...
                            style={"float": "right", "top": 0, "left": 0, "bottom": 0, "right": 0,
                                   "width": "22.5rem", "background-color": "#f8f9fa", "margin-left": "15px"},
                        ),
