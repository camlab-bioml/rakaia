                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                        ...
                        style={"margin-top": "-5px", "margin-bottom": "10px"}),
                                 ...
                                 dbc.Col([html.Div([html.H5("Channel selection", style={"margin-top": "12.5px",
                                                                                        "float": "left"}),
                                          dcc.Checklist(options=[' sorted'], value=[],
                                        id="sort-channels-alpha",style={"width": "20%", "float": "right",
                                        "justifyContent": "right", "margin-left": "200px", "margin-top": "11.5px"})],
                                                   style={"display": "flex"}),
                    ...
                    # html.Div(id='blend-color-legend', style={'whiteSpace': 'pre-line'}),
                        ...
                        dbc.Col([
                            html.Div(
                                ...
                                # html.Div([dcc.Checklist(options=[' log scale'], value=[], id="slider-log-scale",
                                #                style={"width": "100%"})],
