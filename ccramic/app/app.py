    ...
    dash_app.layout = html.Div([
        ...
        html.H3("ccramic"),
            dbc.Tab(label='Image Annotation', tab_id='image-annotation', children=[
                ...
                children=[dbc.Tab(label='Image Analysis',
                ...
                children=[
                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                        ...
                        html.H5("Choose channels for blend", style={'width': '65%', 'display': 'inline-block',
                                                               'margin-left': '30px', "margin-top": "10px"}),
                        dcc.Dropdown(id='image_layers', multi=True,
                                     style={'width': '90%', 'height': '80%', 'display': 'inline-block',
                                            'margin-left': '90px',
                                            'margin-top': '7.5px'}),
                        dcc.Slider(50, 200, 5, value=100, id='annotation-canvas-size'),
                    ...
                    html.Div(dbc.Collapse(
                        ...
                        html.Br(),
                        dbc.Button("Show/hide pixel histogram", id="show-pixel-hist",
                            className="mb-3", color="primary", n_clicks=0, style={"margin-left": "15px"}),
                        ...
                        # 'modeBarButtonsToRemove': ['zoom', 'pan']
                            ...
                            type="default", fullscreen=False)])]), id="pixel-hist-collapse", is_open=False),
                        ...
                        dbc.Button("Advanced blend options", id="blend-offcanvas-button", n_clicks=0,
                        style={"margin-top": "10px"}),
                        html.Br(),
                        dbc.Offcanvas(id="blend-config-offcanvas", title="Canvas configuration",
                        placement="end", style={"width": "30%"},
