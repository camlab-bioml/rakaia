                ...
                children=[
                    dbc.Offcanvas(
                        ...
                        children=[dbc.Tabs(id='data-config',
                                    ...
                                    html.Div([html.Span([
                                        ...
                                        dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                                                              style={"display": "inline-block",
                                                                                     "margin-right": "7.5px",
                                                                                     "margin-top": "3px"}),
                                                                       html.Div("Download canvas image as tiff")],
                                                                      style={"display": "flex"}),
                                        ...
                                        dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                                                              style={"display": "inline-block",
                                                                                     "margin-right": "7.5px",
                                                                                     "margin-top": "3px"}),
                                                                       html.Div("Show additional download links")],
                                                                      style={"display": "flex"}),
                                                   id="open-download-collapse", className="mx-auto", color=None,
                                                   n_clicks=0,
                                                   style={"margin-top": "10px"}),
                                ...
                                html.Br(),
                                html.Br(),
                                dbc.Button("View imported configurations", id="view-db-config-list", style={"width": "50%"}),
                                dbc.Modal(children=dbc.ModalBody(
                                ...
                                "margin-top": "3px"}), html.Div("Save current session")],
                                    style={"display": "flex"}), id="db-save-cur-config",
                                        ...
                                        style={"margin-top": "10px"}),
                                dbc.Alert([], color='success', is_open=False, duration=1500,
                                          id='db-config-submit-alert'),
                                ])],
