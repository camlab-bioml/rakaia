                    ...
                    # html.Div(id='blend-color-legend', style={'whiteSpace': 'pre-line'}),
                        ...
                        dbc.Col([
                            html.Div(
                                ...
                                labelPosition='bottom', value=True, color=DEFAULT_WIDGET_COLOUR, style={"width": "75%",
                                "margin-left": "-15px"}, persistence=config['persistence'], persistence_type='local'),
                                ...
                                dcc.Input(id="custom-scale-val", type="number", value=None,
                                    ...
                                    html.Div([dcc.Checklist(options=[' Apply/refresh filter'], value=[],
                                            ...
                                            style={"width": "85%", "accent-color": DEFAULT_WIDGET_COLOUR}),
                                    ...
                                    html.Div([html.Div([daq.ToggleSwitch(label='Apply mask', id='apply-mask',
                                        labelPosition='bottom', color=DEFAULT_WIDGET_COLOUR, style={"margin-left": "60px"}),
                                    html.Abbr(dcc.Checklist(options=[' add boundary'], value=[' add boundary'],
                                        id="add-mask-boundary", style={"margin-left": "35px",
                                        "margin-top": "10px", "accent-color": DEFAULT_WIDGET_COLOUR}),
                                    ...
                                    marks=dict([(i, str(i)) for i in [0, 0.25, 0.5, 0.75, 1]]),
            ...
            dbc.Tab(label="Panel metadata", tab_id='metadata-tab', label_style={"color": DEFAULT_WIDGET_COLOUR},
                    children=
                        ...
                        html.H6("Panel metadata consists of a list of biomarkers corresponding to one or more "
                                "experiments. ccramic requires internal channel identifiers (corresponding to"
                                " to the channel name) that are used within ccramic sessions to identify individual biomarkers."
