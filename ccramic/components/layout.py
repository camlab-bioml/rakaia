            ...
            children=[
                html.Div([html.A("ccramic", className="navbar-brand me-0 px-3", href="#"),
                    ...
                    children=html.Span([html.I(className="fa-solid fa-solid fa-solid fa-file-export",
                                               style={"display": "flex"}),
                                        html.H6("Show I/O panel", style={"color": "#FFFFFF", "margin-left": "3px"})],
                                       style={"display": "flex"}),
                ...
                children=[
                    dbc.Offcanvas(
                        ...
                        children=[
                                ...
                                html.Br(),
                                html.Br(),
                                html.H5("Annotations/measurements"),
                                html.Div([
                                    dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                                                          style={"display": "inline-block",
                                                                                 "margin-right": "7.5px",
                                                                                 "margin-top": "3px"}), html.Div(
                                        "Download quantification CSV w/ annotations")],
                                                                  style={"display": "flex"}),
                                    ...
                                    dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                                                          style={"display": "inline-block",
                                                                                 "margin-right": "7.5px",
                                                                                 "margin-top": "3px"}),
                                                                   html.Div("Download annotations report (PDF)")],
                                                                  style={"display": "flex"}),
                                    ...
                                    dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                                                          style={"display": "inline-block",
                                                                                 "margin-right": "7.5px",
                                                                                 "margin-top": "3px"}),
                                                                   html.Div("Download annotation masks (zip)")],
                                                                  style={"display": "flex"}),
                                    ...
                                    dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                                                          style={"display": "inline-block",
                                                                                 "margin-right": "7.5px",
                                                                                 "margin-top": "3px"}),
                                                                   html.Div("Download point/click annotations (CSV)")],
                                                                  style={"display": "flex"}),
                                    ...
                                    dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                                                          style={"display": "inline-block",
                                                                                 ...
                                                                                 "margin-top": "3px"}),
                                                                   html.Div(
                                                                       "Download object annotations (region/gating)")],
                                                                  style={"display": "flex"}),
