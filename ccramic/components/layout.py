                ...
                children=[
                    dbc.Offcanvas(
                        ...
                        html.Div([html.Span([
                            ...
                            style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                            html.Div("Download canvas image as tiff")], style={"display": "flex"}),
                            ...
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                                           ...
                                                           html.Div("Download canvas image as HTML")],
                                                          style={"display": "flex"}),
                            ...
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                                          ...
                                                          style={"display": "flex"}),
                                       id="btn-download-session-config-json", className="mx-auto", color=None,
                                       n_clicks=0, style={"margin-top": "10px"}),
