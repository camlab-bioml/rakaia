            ...
            children=[
                html.Div([html.A("ccramic", className="navbar-brand me-0 px-3", href="#"),
                    ...
                    children=html.Span([html.I(className="fa-solid fa-solid fa-solid fa-file-export",
                                               style={"display": "flex"}),
                                        html.H6("Show input panel", style={"color": "#FFFFFF", "margin-left": "3px"})],
                                       style={"display": "flex"}),
                ...
                children=[
                    dbc.Offcanvas(
                        ...
                        children=[
                                ...
                                text='Import/copy imaging data (.MCD, .tiff, etc.) files using drag and drop',
                                              chunk_size=100,
                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                        # TODO: use this div to hold size and coord components
                        dbc.Row([dbc.Col([
                            html.H5("Choose channels",
                                    style={'width': '100%', "margin-top": "3px", "text-align": "center"}),
                            dcc.Checklist(options=[' sort (A-z)'], value=[],
                                          id="sort-channels-alpha", style={"margin-top": "12px",
                                                                           "accent-color": DEFAULT_WIDGET_COLOUR,
                                                                           "text-align": "center"},
                                          persistence=config['persistence'], persistence_type='local'),
                            dcc.Dropdown(id='image_layers', multi=True, value=[], style={"margin-top": "10px",
                                                                                         "width": "100%",
                                                                                         "text-align": "center"}),
                            html.Div([
                                      html.Div([dbc.Button(
                                          children=html.Span([html.Div("Fullscreen"),
                                                             ...
                                                             style={"width": "100vw", "margin-top": "-5px",
                                                                    "margin-bottom": "10px"}),
                                          id="make-canvas-fullscreen", color=None, n_clicks=0,
                                          ...
                                          dbc.Button(children=html.Span([html.Div("Prev ROI"),
                                                                        ...
                                                                        style={"width": "100vw", "margin-top": "-5px",
                                                                               "margin-bottom": "10px"}),
                                                     id="prev-roi", color=None, n_clicks=0,
                                                     style={"margin-left": "5px", "height": "100%", "width": "auto"}),
                                          dbc.Button(children=html.Span([html.Div("Next ROI"),
                                                                         html.I(className="fa-solid fa-arrow-right",
                                                                                style={"display": "inline-block"})],
                                                                        style={"width": "100vw", "margin-top": "-5px",
                                                                               "margin-bottom": "5px"}),
                                                     id="next-roi", color=None, n_clicks=0,
                                                     style={"margin-left": "5px", "height": "100%", "width": "auto"}),
                                          html.Br(),
                                          ...
                                          dbc.Button(
                                              html.Span([html.Div("Set", style={"margin-right": "5px", "height": "150%",
                                                                                "font-size": "16px"}),
                                          ...
                                          html.Br(),
                                          html.Div(style={"margin-top": "20px", "height": "100%", "width": "auto"},
                                                   id="bound-shower"),
                                          dbc.Button(
                                              children=html.Span([html.I(className="fa-solid fa-gears",
                                                                         style={"display": "inline-block",
                        ...
                        dbc.Col(html.Div([render_default_annotation_canvas(input_id="annotation_canvas")],
                                 style={"display": "flex", "justifyContent": "center", "margin": "0px",
                                        "padding": "0px"},
                                 id="canvas-div-holder"), width=10)]),
                    ], style={"margin-top": "5px"}), width=9),
                        dbc.Col([
                            html.Div([
                                html.Div([html.H5("Channel modification",
                                                  style={'width': '77.5%', "margin-top": "3px",
                                                         "text-align": "center"}),
                                          dbc.Button(children=html.Span([html.I(className="fa-solid fa-circle-question",
                                                                                style={"display": "inline-block",
                                                                                       "margin-right": "7.5px",
                    ...
                    html.Div([dcc.Input(id="dataset-query-number", type="number",
                              ...
                              dbc.Button(children=html.Span([html.I(className="fa-solid fa-bolt",
                                                                    style={"display": "inline-block",
                                                                           "margin-right": "7.5px",
                                                                           "margin-top": "3px"}),
                                                             html.Div("Execute query")], style={"display": "flex"}),
