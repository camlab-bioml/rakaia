        ...
        html.Header(
            ...
            children=[
                html.Div([html.A("ccramic", className="navbar-brand me-0 px-3", href="#"),
                    ...
                    children=html.Span([html.I(className="fa-solid fa-solid fa-solid fa-file-export",
                                               style={"display": "flex"}),
                                        html.H6("Show config panel", style={"color": "#FFFFFF", "margin-left": "3px"})],
                                       style={"display": "flex"}),
            ...
            dbc.Tab(label='Image annotation', tab_id='image-annotation',
                ...
                children=[
                    dbc.Offcanvas(
                        id="inputs-offcanvas",
                        title= html.Div(["Configure inputs/export for ccramic"],
                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                        ...
                        dbc.Col([
                            ...
                            dbc.Tabs([
                                ...
                                dbc.Tab(label='Channel', children=[
                                    ...
                                    html.Div(
                                        [dbc.Button("Reset to default", id="set-default-rangeslider", className="me-1",
                                                    size="sm", color='dark', outline=True, style={"float": "left",
                                                                                                  "margin-right": "12.5px",
                                                                                                  "height": "50%"}),
