...
This repository contains rakaia standalone builds for Windows, Linux, and macOS (currently only
Intel-based laptops, M1/M2 builds are coming soon). You should download the zip bundle corresponding to your OS.
Once the zip bundle is downloaded and unzipped, there should be a single file named `rakaia_{os}_{version}` in the unzipped destination.

**Note**: On initial execution, the bundles may take a while (3-4 minutes) to initialize, as
