                                        ...
                                        width=10),
                                         ...
                                         dbc.Col([du.Upload(id='upload-coregister', max_file_size=5000000,
                                                  ...
                                                  wrap_child_in_loading(dcc.Dropdown(id='coregister_options', multi=False,
                                                               placeholder='Select WSI', style={'white-space':'initial',
                                                           'overflow-wrap': 'anywhere'}),
                                                        fullscreen=False, wrap=config['use_loading']),
                                                  html.Br(),
                                                  dbc.Button("Read local WSI", id='read-local-wsi',
                                                             style={"align": "center",
                                                  ...
                                                  du.Upload(id='upload-transformation-coordinates', max_file_size=5000000,
                                                            text='Upload affine transformation for Xenium',
                                                            chunk_size=100, max_total_size=5000000, max_files=100,
                                                            filetypes=['csv'],
                                                            default_style={"margin-top": "12.5px", "height": "8vh"}),
                                                  html.Br(),
                                                  ...
                                                  dcc.Input(type="number", value=0.2125,
                                                            placeholder="Set Xenium WSI scaling factor",
                                                            style={"width": "50%"}, id='xenium-scaling-factor'),
                                                  dbc.Tooltip(TOOLTIPS['xenium-wsi-scaling'], target="xenium-scaling-factor"),
                                                  html.Br(),
                                                  html.Br(),
