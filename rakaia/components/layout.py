                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                                ...
                                "border": "1px solid black", "height": "700px", "margin": "5px", "float": "right",
                                        ...
                                        width=10),
                                         ...
                                         dbc.Col([
                                            ...
                                            html.Br(),
                                            html.Br(),
                                            html.H6("Scaling factor (μm/pixel)"),
                        ...
                        dbc.Col([
                            ...
                            dcc.Input(type="text", value=None, id='stitch-image-id',
                                      placeholder="Set new stitched image name", style={"width": "90%", "margin": "7px"}),
                            dbc.Button("Get slide coordinates from current ROI",
                            id="cur-roi-slide-parse", className="me-1",
                            size="sm", color='dark', outline=True,
                            style={"align-items": "center", "float": "center", "justify-content": "center",
                                "height": "50%", "margin": "7px"}),
                            dbc.Tooltip(TOOLTIPS['cur-roi-slide-parse'], target="cur-roi-slide-parse", placement='left'),
                            dbc.Button("Create stitched image",
                            id="stitch-image-create", className="me-1",
                            size="sm", color='dark', outline=True,
                            style={"align-items": "center", "float": "center",
                            "justify-content": "center", "height": "50%", "margin": "7px"}),
                            html.Br(),
                            html.Br(),
                            html.B("Set image coordinates for image to switch (x-min, y-min)"),
                            html.Div([
                            ...
                            dcc.Dropdown(placeholder="Select stitched image to modify", multi=False,
                                         style={"margin": "7px"}, id='stitch-image-select'),
                            dbc.Button("Get stitch coordinates for current ROI",
                            id="cur-roi-stitch-parse", className="me-1", size="sm", color='dark', outline=True,
                                style={"align-items": "center", "float": "center", "justify-content": "center",
                                    "height": "50%", "margin": "7px"}),
                            dbc.Tooltip(TOOLTIPS['cur-roi-stitch-parse'], target="cur-roi-stitch-parse", placement='left'),
                            dbc.Button("Add canvas to selected stitch",
                            id="stitch-image-update", className="me-1",
                            size="sm", color='dark', outline=True,
                            style={"align-items": "center", "float": "center", "justify-content": "center",
                                "height": "50%", "margin": "7px"}),
                            dbc.Button("Preview selected stitch",
                                id="stitch-image-preview", className="me-1",
                                size="sm", color='dark', outline=True,
                                style={"align-items": "center", "float": "center",
                                "justify-content": "center", "height": "50%", "margin": "7px"}),
