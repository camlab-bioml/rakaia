                                ...
                                "border": "1px solid black", "height": "700px", "margin": "5px", "float": "right",
                                        ...
                                        width=10),
                                         ...
                                         dbc.Col([
                                            ...
                                            html.Br(),
                                            dbc.Button("Query patch (hist2query)", id='osd-query-modal-open',
                                            ...
                                            style={"width": "100%"}, id='hist2query-host'),
                                            html.Br(),
                                            dcc.Input(type="number", placeholder="Set port for hist2query",
                                            value=6000, style={"width": "100%"}, id='hist2query-port'),
                                            html.Br(),
                                            dbc.Button("Query patch (hist2query)", id='osd-query-run',
                                            style={"align": "center", "background-color": DEFAULT_WIDGET_COLOUR,
                                            "float": "center"}, n_clicks=0),
                                            html.Br(),
                                            html.H6("Query results"),
                                            dcc.Loading(
                                            dash_table.DataTable(id='hist2query-results',
                                            columns=[{'id': p, 'name': p, "presentation": "markdown"} for p in ['index', 'project', 'slide', 'url', 'similarity']],
