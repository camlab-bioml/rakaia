...
def register_app_layout(config: dict, cache_dest: Union[str, Path]):
    ...
    return html.Div([
        ...
        html.Header(
            ...
            children=[
                ...
                dbc.Modal(children=dbc.ModalBody([
                    ...
                    children=[
                        ...
                        html.Br(),
                        html.Div([daq.ToggleSwitch(label='Enforce single marker lazy loading', id='always-single-marker-loading',
                                                   labelPosition='bottom', color=DEFAULT_WIDGET_COLOUR, value=False,
                                                   persistence=config['persistence'], persistence_type='local',
                                                   style={"margin-left": "10px", "width": "50%",
                                                          "textAlign": "center"}),
                                  dbc.Tooltip(TOOLTIPS['always-single-marker-load'], target="always-single-marker-loading",
                                              placement='bottom'),
                                  daq.ToggleSwitch(label='Session messages', id='toggle-session-messages',
                                                   labelPosition='bottom', color=DEFAULT_WIDGET_COLOUR, value=True,
                                                   persistence=config['persistence'], persistence_type='local',
                                                   style={"margin-left": "10px", "width": "50%",
                                                          "textAlign": "center"}),
                                  html.Div([html.B("Max viewport", style={"margin-right": "10px",
                                                "width": "65%", "float": "center", "textAlign": "center"}),
                                            dcc.Input(id='canvas-viewport-max', type='number', value=150, debounce=True,
                                                      style={"width": "40%", "height": "50%", "float": "center"},
                                                      persistence=config['persistence'], persistence_type='local'),
                                            dbc.Tooltip(TOOLTIPS['max-viewport'], target="canvas-viewport-max", placement='bottom')
                                            ], style={"display": "flex", "float": "center", "justify-content": "center"}),
                                  ],
                        ...
                        html.Div([
                            ...
                            html.Br(),
                            dcc.Dropdown(options=[], value=None, placeholder='Select preset',
                                         id='preset-options', style={"width": "100%"}),
                    ...
                    html.Br(),
                    html.Div([html.B("Annotation circle radius", style={"margin-right": "20px"}),
                    ...
                    html.Br(),
                        html.Div([html.B("Legend orientation"),
                                  dcc.RadioItems([{'label': 'Vertical', 'value': 'vertical'},
                                        {'label': 'Horizontal', 'value': 'horizontal'}],
                                'vertical', inline=True, id="legend_orientation",
                                persistence=config['persistence'], persistence_type='local',
                                style={"accent-color": DEFAULT_WIDGET_COLOUR, 'align': 'left', 'float': 'left'},
                                ...
                                labelStyle={'display': 'flex', 'alignItems': 'center', 'gap': '4px'})],
                                 style={"display": "flex", "alignItems": "center", "float": "center"}),
                        html.Br(),
            ...
            html.Div([dcc.Dropdown(id='data-collection', multi=False, options=[],
                placeholder='Load an ROI into the canvas', style={'justifyContent': 'right', 'white-space':'initial',
                                                    'overflow-wrap': 'anywhere', 'textAlign': 'right'}),
                ...
                children=[
                    dbc.Offcanvas(
                        ...
                        children=[
                                ...
                                text='Choose or drop imaging/spatial data files',
                                    ...
                                    filetypes=['tif', 'tiff', 'h5', 'mcd', 'txt', 'h5ad', 'TIF', 'TIFF'],
                                          default_style={"line-height": "5vh", "min-height": "7vh",
                                                         "max-height": "7vh",
                                                         "vertical-align": "top"}),
                                    dbc.Tooltip('Supported file types: tiff, mcd, txt, h5ad',
                                                target="upload-image"),
                                    html.H5("or", style={'width': '35%', 'margin-top': '5px'}),
                                    dcc.Input(id="read-filepath", type="text",
                                    placeholder="Read files or directory from path (local sessions only)",
                                    ...
                                    html.Div([html.Span([
                                        ...
                                        du.Upload(id='upload-mask', max_file_size=50000,
                                                  text='Choose or drop mask file(s)',
                                                  max_total_size=50000, max_files=1000,
                                                  chunk_size=100,
                                                  filetypes=['tif', 'tiff'],
                                                  default_style={"line-height": "5vh", "min-height": "7vh",
                                                "max-height": "7vh", "vertical-align": "top", "margin-bottom": "20px"}),
                                        dbc.Tooltip('Supported file types: tiff', target="upload-mask"),
                                        du.Upload(id='upload-quantification', max_file_size=5000,
                                                  filetypes=['h5ad', 'h5', 'csv'],
                                                  text='Choose or drop quantification/expression results',
                                                  max_files=1, upload_id="upload-quantification",
                                                  default_style={"line-height": "5vh", "min-height": "7vh",
                                                                 "max-height": "7vh", "vertical-align": "top",
                                                                 "margin-bottom": "20px"}),
                                        dbc.Tooltip('Supported file types: CSV, h5ad', target="upload-quantification"),
                                        du.Upload(id='upload-param-json', max_file_size=1000,
                                                  filetypes=['json'],
                                                  text='Choose or drop blend/session parameters',
                                                  max_files=1, upload_id="upload-param-json",
                                                  default_style={"line-height": "5vh", "min-height": "7vh",
                                                                 "max-height": "7vh", "vertical-align": "top",
                                                                 "margin-bottom": "20px"}),
                                        dbc.Tooltip('Supported file types: json', target="upload-param-json"),
                                        html.Br(),
                                        dbc.Button(children=html.Span([html.I(className="fa-solid fa-file-import",
                                        style={"display": "inline-block", "margin-right": "7.5px",
                                        "margin-top": "3px"}),
                                        html.Div("Show/hide additional imports (UMAP, WSI, etc.)")],
                                        style={"display": "flex", "margin-top": "10px"}),
                                                   ...
                                                   style={"display": "flex", "width": "auto", "align-items": "center",
                                                          ...
                                                          "border": "1px black solid", "padding": "7.5px"
                                                          }),
                                        html.Br(),
                                        dbc.Collapse([
                                            du.Upload(id='upload-panel-info', max_file_size=1000, max_files=1,
                                                      text='Choose or drop panel info (CSV)',
                                                      filetypes=['csv'], upload_id="upload-image",
                                                      default_style={"line-height": "5vh", "min-height": "7vh",
                                                                     "max-height": "7vh", "vertical-align": "top",
                                                                     "margin-bottom": "20px"}),
                                            dbc.Tooltip('Supported file types: CSV', target="upload-panel-info"),
                                            du.Upload(id='upload-umap-coordinates', max_file_size=10000,
                                                      text='Choose or drop UMAP coordinates',
                                                      chunk_size=100, max_total_size=10000, max_files=1,
                                                      filetypes=['csv'],
                                                      default_style={"line-height": "5vh", "min-height": "7vh",
                                                                     "max-height": "7vh", "vertical-align": "top",
                                                                     "margin-bottom": "20px"}),
                                            dbc.Tooltip('Supported file types: CSV', target="upload-umap-coordinates"),
                                            du.Upload(id='upload-coregister', max_file_size=5000000,
                                                      text='Choose or drop WSI (i.e. H & E) (requires libvips)',
                                                      chunk_size=100, max_total_size=5000000, max_files=100,
                                                      filetypes=WSI_FILE_EXTENSIONS,
                                                      default_style={"line-height": "5vh", "min-height": "7vh",
                                                                     "max-height": "7vh", "vertical-align": "top",
                                                                     "margin-bottom": "20px"}),
                                            dbc.Tooltip(f'Supported file types: '
                                            f'{", ".join(wsi for wsi in WSI_FILE_EXTENSIONS)}', target="upload-coregister"),
                                            du.Upload(id='upload-transformation-coordinates', max_file_size=5000000,
                                                      text='Choose or drop affine transformation matrix for WSI',
                                                      chunk_size=100, max_total_size=5000000, max_files=100,
                                                      filetypes=['csv'],
                                                      default_style={"line-height": "5vh", "min-height": "7vh",
                                                                     "max-height": "7vh", "vertical-align": "top",
                                                                     "margin-bottom": "20px"}),
                                            dbc.Tooltip('Supported file types: CSV', target="upload-transformation-coordinates"),
                                            du.Upload(id='upload-point-annotations', max_file_size=5000, max_files=1,
                                                      text='Choose or drop point/click annotations',
                                                      filetypes=['csv'], upload_id="upload-point-annotations",
                                                      default_style={"line-height": "5vh", "min-height": "7vh",
                                                                     "max-height": "7vh", "vertical-align": "top",
                                                                     "margin-bottom": "20px"}),
                                            dbc.Tooltip('Supported file types: CSV', target="upload-point-annotations"),
                                            du.Upload(id='upload-canvas-shapes', max_file_size=10000,
                                                      text='Choose or drop canvas shapes',
                                                      chunk_size=100, max_total_size=10000, max_files=1,
                                                      filetypes=['json'],
                                                      default_style={"line-height": "5vh", "min-height": "7vh",
                                                                     "max-height": "7vh", "vertical-align": "top",
                                                                     "margin-bottom": "20px"}),
                                            dbc.Tooltip('Supported file types: json', target="upload-canvas-shapes"),
                                            du.Upload(id='upload-custom-metadata', max_file_size=10000,
                                                      text='Choose or drop image-level metadata',
                                                      chunk_size=100, max_total_size=10000, max_files=1,
                                                      filetypes=['csv'],
                                                      default_style={"line-height": "5vh", "min-height": "7vh",
                                                                     "max-height": "7vh", "vertical-align": "top",
                                                                     "margin-bottom": "20px"}),
                                            dbc.Tooltip('Supported file types: CSV', target="upload-custom-metadata"),
                                ...
                                html.Div([
                                dcc.Dropdown(id='db-config-options', multi=False, style={"width": "100%"}),
                                ], style={"width": "70%"}),
                                html.Br(),
                                html.Br(),
                                html.Br(),
                                ...
                                html.Div([
                                    ...
                                    dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                               ...
                                               n_clicks=0, style={"margin-top": "10px"}),
                                    dcc.Download(id="download-canvas-shapes"),
                                    dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                                                          style={"display": "inline-block",
                                                                                 "margin-right": "7.5px",
                                                                                 "margin-top": "3px"}),
                                                                   html.Div("Current canvas shapes (JSON)")],
                                                                  style={"display": "flex"}),
                                               id="btn-download-canvas-shapes", className="mx-auto", color=None,
                                               n_clicks=0, style={"margin-top": "10px"}),
                            ...
                            children = [
                                ...
                                "border": "1px solid black", "height": "700px", "margin": "5px", "float": "right",
                                        ...
                                        width=10),
                                         ...
                                         dbc.Col([
                                             html.Br(),
                                             dbc.Button("Select/Read WSI", id='wsi-modal',
                                                             style={"align": "center",
                                            ...
                                            dcc.Input(type="number", value=0.2125,
                                                            placeholder="Set WSI scaling factor",
                                                            style={"width": "50%"}, id='wsi-scaling-factor',
                                                        persistence=config['persistence'], persistence_type='local'),
                                            dbc.Tooltip(TOOLTIPS['wsi-scaling-factor'], target="wsi-scaling-factor",
                                            placement="right"),
                                            html.Br(),
                                            html.Br(),
                                            ...
                                            style={"width": "20%", "margin": "10px"}, id='hist2query-host',
                                                      persistence=config['persistence'], persistence_type='local'),
                                            dcc.Input(type="number", placeholder="Set port for hist2query",
                                            value=6000, style={"width": "10%", "margin": "12.5px", "height": "110%"}, id='hist2query-port',
                                                      persistence=config['persistence'], persistence_type='local'),
                                            ], style={"display": "flex"}),
                                            html.Div([
                                            html.H6('k result size', style={"margin": "10px"}),
                                            dcc.Input(type="number", placeholder="k size", min=1, max=10000,
                                            value=50, style={"width": "10%", "margin": "7.5px", "height": "25%"},
                                            id='hist2query-k', persistence=config['persistence'], persistence_type='local'),
                                            daq.ToggleSwitch(label='Group results by slide', id='hist2query-group',
                                            labelPosition='bottom', value=True, color=DEFAULT_WIDGET_COLOUR,
                                            style={"width": "15%", "margin": "10px"}),
                                            html.H6('Tile number', style={"margin": "10px"}, id='wsi-ile-number-label'),
                                            dcc.Dropdown(id='hist2query-tile-number', multi=False, placeholder='Tile number',
                                            options=[1, 4, 9, 16, 25], value=9, persistence=config['persistence'], persistence_type='local',
                                            style={'justifyContent': 'left', 'white-space': 'initial', 'width': '40%', "margin": "5px",
                                                                    'overflow-wrap': 'anywhere', 'textAlign': 'left'}),
                                            dbc.Tooltip(TOOLTIPS['wsi-query-tile-number'], target="wsi-ile-number-label",placement='top'),
                                            ], style={"display": "flex"}),
                                            dbc.Button("Send query", id='osd-query-run',
                                            style={"align": "center", "background-color": DEFAULT_WIDGET_COLOUR,
                                            "float": "center", "margin": "10px"}, n_clicks=0),
                                            html.Br(),
                                         ...
                                         dbc.Modal(children=dbc.ModalBody(
                                             [dcc.Input(type="text", placeholder="Read WSI directly from local filepath",
                                              ...
                                              html.Br(),
                                              html.Br(),
                                              dbc.Button("Import local WSI", id='import-local-wsi',
                                                style={"align": "center", "background-color": DEFAULT_WIDGET_COLOUR,
                                                                "float": "center"}, n_clicks=0),
                                              html.Br(),
                                              html.Br(),
                                              wrap_child_in_loading(dcc.Dropdown(id='coregister_options', multi=False,
                                            placeholder='Select WSI', style={'justifyContent': 'left', 'white-space':'initial',
                                                    'overflow-wrap': 'anywhere', 'textAlign': 'left'}),
                                            fullscreen=False, wrap=config['use_loading']),
                                              html.Br(),
                                              html.Br(),
                                              html.Div([html.B("WSI transformation matrix",
                                                               style={'width': 'auto', "margin-top": "7.5px",
                                                                      "margin-left": "12.5px", "text-align": "left"}),
                                            dbc.Button(children=html.Span(
                                                       ...
                                                       style={"display": "flex", "margin-top": "7.5px",
                                                              "float": "center",
                                                              "textAlign": "center"}),
                                              dbc.Tooltip(TOOLTIPS['wsi-transform'], target="wsi-transform-hover", placement='right'),
                                              dcc.Dropdown(id='wsi_transform_options', multi=False,
                                              placeholder='Select WSI transformation matrix',
                                              style={'justifyContent': 'left', 'white-space': 'initial', 'overflow-wrap': 'anywhere', 'textAlign': 'left'}),
                                              dcc.Checklist(options=[' Use matrix inverse'], value=[],
                                                            id="wsi-matrix-inverse",
                                                            style={"margin-top": "10px", "width": "50%",
                                                                   "accent-color": DEFAULT_WIDGET_COLOUR,
                                                                   "text-align": "left"},
                                                            persistence=config['persistence'],
                                                            persistence_type='local'),
                                              dbc.Tooltip(TOOLTIPS['wsi-transform-inv'], target="wsi-matrix-inverse",
                                                          placement='right'),
                                              ]),
                                             id="wsi-local-import-modal", size='l'),
                                         ]),
                            ])
                        ...
                        dbc.Col([
                            html.Div([
                                ...
                                dcc.Dropdown(id='image_layers', multi=True, value=[],
                                             ...
                                             style={"margin-top": "5px", "width": "100%", "padding": "5px", "height": "25%"}),
                            dbc.Tabs([
                                        ...
                                        html.Br(),
                                            ...
                                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-list",
                                                                                  style={"display": "inline-block",
                                                                                         "margin-right": "7.5px",
                                                                                         "margin-top": "3px"}),
                                                                           html.Div("Show/hide channel table")],
                                                                          style={"display": "flex",
                                                                                 "margin": "5px"}),
                                            ...
                                            html.Div(dbc.Collapse(
                                                html.Div([dbc.Button(
                                                    ...
                                                    id="set-sort",
                                                    color="dark", outline=True, n_clicks=0, className="mx-auto",
                                                    style={"display": "flex", "width": "auto", "align-items": "center",
                                                           "float": "center", "justify-content": "center",
                                                           "margin": "10px"}),
                                                    dag.AgGrid(
                                ...
                                dbc.Tab(label='Channel', tab_id='channel-config-tab',
                                    label_style={"color": DEFAULT_WIDGET_COLOUR}, children=[
                                    html.Div([html.B("Channel modification",
                                                      style={'width': 'auto', "margin-top": "7.5px",
                                                             "margin-left": "12.5px", "text-align": "left"}),
                                              dbc.Button(
                                             ...
                                             style={"display": "flex", "margin-top": "7.5px", "float": "center",
                                                    "textAlign": "center"}),
                                    dbc.Tooltip(TOOLTIPS['channel-mod'], target="channel-mod-hover"),
                                    dcc.Dropdown(id='images_in_blend', multi=False, style={"margin-top": "2.5px"},
                                    ...
                                    dmc.Center([dmc.ColorPicker(swatches=DEFAULT_SWATCHES,
                                                                ...
                                                                persistence_type='local',
                                                                persisted_props='swatches')], style={"margin": "10px"}),
                                    ...
                                    html.Div(
                                        [dbc.Button(["Reset to", html.Br(), "default scaling"], id="set-default-rangeslider", className="me-1",
                                                    size="sm", color='dark', outline=True, style={"float": "left",
                                                                                                  "margin-right": "12.5px",
                                                                                                  "height": "50%"}),
                                         # dbc.Tooltip(TOOLTIPS['default-scaling'], target="set-default-rangeslider"),
                                         dcc.Checklist(options=[' Set range max to upper bound'],
                                                       value=[], id="custom-slider-max",
                                                       labelStyle={"margin-left": "5px", "float": "right",
                                                                   "justify-content": "right"},
                                                       inline=False,
                                                       style={"width": "100%", "float": "right",
                                                              "margin-right": "5px", "gap": "10px",
                                                              "align-items": "right", "textAlign": "right",
                                                              "accent-color": DEFAULT_WIDGET_COLOUR})],
                                        style={"display": "flex", "margin": "20px"}),
                                    html.Div([dcc.Checklist(options=[' Apply filter'], value=[],
                                              ...
                                              html.H6("Filter kernel and sigma"),
                            ...
                            dbc.Tab(label='Stitch', label_style={"color": DEFAULT_WIDGET_COLOUR},
                                        children=[
                            html.Br(),
                            html.B("Create stitched image (width, height)", style={"margin-left": "10px"}),
                            dcc.Input(type="number", value=None, id='stitch-image-create-width', placeholder="Set width",
                                    style={"width": "35%", "margin": "10px"}, debounce=True),
                            dcc.Input(type="number", value=None, id='stitch-image-create-height', placeholder="Set height",
                                    style={"width": "35%", "margin": "10px"}, debounce=True),
                            dcc.Input(type="text", value=None, id='stitch-image-id',
                                      placeholder="Set new stitched image name", style={"width": "90%", "margin": "10px"}),
                            dbc.Modal(children=dbc.ModalBody([html.Div(id='stitch-size-information',
                                style={'whiteSpace': 'pre-line'})]), id="stitch-size-alert-modal", size='l'),
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-arrows-to-circle",
                            style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                            html.Div("Get slide coordinates from current ROI")], style={"display": "flex", "margin-left": "5px"}),
                            id="cur-roi-slide-parse", className="mx-auto", size="sm", color=None,
                            ...
                            dcc.Input(type="number", value=None, id='stitch-image-y-min', placeholder="",
                                      style={"width": "35%", "margin": "10px"}),
                            ], style={"display": "flex", "alignItems": "center", "width": "80%"}),
                            dcc.Loading(dcc.Dropdown(placeholder="Select stitched image to modify", multi=False,
                                         style={"margin": "5px"}, id='stitch-image-select'), type="default",
                                        fullscreen=False, color=DEFAULT_WIDGET_COLOUR),
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-arrows-to-circle",
                            style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                            html.Div("Get stitch coordinates for current ROI")],
                            style={"display": "flex", "margin-left": "5px"}),
                            id="cur-roi-stitch-parse", className="mx-auto", size="sm", color=None, outline=False,
                            n_clicks=0, style={"align-items": "center", "float": "center",
                            "justify-content": "center", "height": "50%", "margin": "10px"}),
                            dbc.Tooltip(TOOLTIPS['cur-roi-stitch-parse'], target="cur-roi-stitch-parse", placement='left'),
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-plus",
                            style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                            html.Div("Add canvas to selected stitch")],
                            style={"display": "flex", "margin-left": "5px"}),
                            id="stitch-image-update", className="mx-auto", size="sm", color=None,
                            outline=False, n_clicks=0, style={"align-items": "center", "float": "center",
                            "justify-content": "center", "height": "50%", "margin": "10px"}),
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-plus",
                            style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                            html.Div("Add dataset gallery ROIs to current stitch")],
                            style={"display": "flex", "margin-left": "5px"}),
                            id="stitch-from-roi-gallery", className="mx-auto", size="sm",
                            color=None, outline=False, n_clicks=0,
                            style={"align-items": "center", "float": "center",
                            "justify-content": "center", "height": "50%", "margin": "10px"}),
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-image",
                            style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                            html.Div("Preview selected stitch (low-res)")],
                            style={"display": "flex", "margin-left": "5px"}),
                            id="stitch-image-preview", className="mx-auto", size="sm",
                            color=None, outline=False, n_clicks=0,
                            style={"align-items": "center", "float": "center",
                            "justify-content": "center", "height": "50%", "margin": "10px"}),
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-image",
                            style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                            html.Div("View stitch in WSI tab (full-res)")],
                            style={"display": "flex", "margin-left": "5px"}), id="stitch-image-to-wsi",
                            className="mx-auto", size="sm", color=None, outline=False, n_clicks=0,
                            style={"align-items": "center", "float": "center",
                            "justify-content": "center", "height": "50%", "margin": "10px"}),
                            dbc.Modal(children=dbc.ModalBody([html.Div([
                            dbc.Row(id="stitch-preview-row"),
                            ], style={"max-width": "100%", "max-height": "100%"})]), id='stitch-preview-modal', size='xl'),
                            html.Br(),
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                            style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                            html.Div("Download selected stitch (zip)")], style={"display": "flex", "margin-left": "5px"}),
                            id="stitch-image-download", className="mx-auto", size="sm", color=None, outline=False,
                            n_clicks=0, style={"align-items": "center", "float": "center",
                            "justify-content": "center", "height": "50%", "margin": "10px", "margin-bottom": "15px"}),
                            html.Br(),
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-trash",
                            style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                            html.Div("Delete select stitch")], style={"display": "flex",
                            "margin-left": "5px"}), id="stitch-image-delete", className="mx-auto", size="sm",
                            color=None, outline=False, n_clicks=0, style={"align-items": "center", "float": "center",
                            "justify-content": "center", "height": "50%", "margin": "10px", "margin-bottom": "15px"}),
                            wrap_child_in_loading(dcc.Download(id="download-stitch-image"), fullscreen=False,
                            wrap=config['use_loading']),
                            html.Br(),
                            html.Br(),
                            wrap_child_in_loading(dcc.Store(id='stitched_images'), fullscreen=False,
                            wrap=config['use_loading'])], style={"alignItems": "center", "gap": "5px"})
                            ...
                            active_tab='channel-config-tab'),
                                ...
                                dbc.Tabs(id='config-subtabs', children=[
                                    ...
                                    children=[
                                        ...
                                        html.Div([
                                            html.H6("Global filter kernel and sigma"),
                                            html.Div([
                                                dcc.Dropdown([1, 3, 5, 7, 9], 3, id='global-kernel-val-filter',
                                                             style={"width": "100%"}),
                                        ...
                                        # html.Br(),
                                        # html.Br(),
                                        html.H5("Mask configuration", style={"margin-top": "10px",
                                                                             "margin-bottom": "15px"}),
                                    ...
                                    dbc.Tab(label='Gating', label_style={"color": DEFAULT_WIDGET_COLOUR},
                                            children=[
                                                ...
                                                html.Br(),
                                                html.Br(),
                                                html.H6("Modify gating parameters (min-max norm, 0-1)"),
                                                ...
                                                html.Div([
                                                    ...
                                                    html.Br(),
                                                html.Div([
                                                dcc.RadioItems([{'label': 'Intersection', 'value': 'intersection'},
                                                {'label': 'Union', 'value': 'union'}], 'intersection',
                                                id='gating-blend-type', style={"margin-top": "7.5px",
                                                "margin-left": "15px", "accent-color": DEFAULT_WIDGET_COLOUR,
                                                "width": "35%"}, labelStyle={'display': 'flex', 'alignItems':
                                                        'center', 'gap': '4px'},
                                            ...
                                            html.Div([
                                                dcc.Input(type='text', value=None, debounce=True,
                                                          placeholder='Add comma separated ID list',
                                                          id='custom-id-gating', style={"width": "80%", "height": "40%"}),
                                                daq.ToggleSwitch(label='Gate on ID list', id='apply-gating-custom',
                                                                 labelPosition='bottom', value=False,
                                                                 color=DEFAULT_WIDGET_COLOUR,
                                            ...
                                            html.Br(),
                                            html.B("Annotate gated objects: set cat and value",
                                                   style={"width": "100%", "margin-bottom": "15px"}),
                                            html.Div([dcc.Dropdown(id='quant-annotation-col-gating',
                                            multi=False, options=['object_annotation_1'], placeholder='Gating category',
                                ...
                                dcc.Input(id="name-cur-blend", type="text", value=None,
                                    placeholder="Set blend save name", style={"width": "65%", "height": "175%",
                                                                     "margin-top": "15px"}),
                                ...
                                dcc.Dropdown(options=[], value=None, id='saved-blend-options',
                                        style={"width": "100%"}, multi=False),
                                html.Br(),
                                html.Br(),
                                html.B("Marker correlation"),
                                html.Br(),
                                html.Br(),
                                ...
                                children=[html.B('Regions', style={"margin-top": "10px"}),
                                dbc.Button(children=html.Span([html.I(className="fa-solid fa-download",
                                style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"})],
                                style={"display": "flex"}),
                                id="download-region-statistics", className="mx-auto", color=None,
                                size='sm', n_clicks=0, style={"margin-top": "10px", "float": "right"}),
                                dbc.Tooltip(TOOLTIPS['download-region-statistics'], target="download-region-statistics"),
                                html.Br(),
                                ...
                                id="compute-region-statistics", className="mx-auto", color=None,
                                n_clicks=0, style={"margin-top": "10px"}),
                                html.Br(),
                                html.Div(dbc.Collapse(html.Div([
                                html.Div([dash_table.DataTable(id='selected-area-table',
                                columns=[{'id': p, 'name': p} for p in RegionStatisticGroups.columns],
                                data=None, style_table={"max-width": "inherit", "overflowX": "auto", "width": "95%"})],
                                         style={"width": "100%", "display": "flex"}, className="region-stats")]),
                                ...
                                html.Br(),
                                html.Div([
                                html.B('Click-point/coordinates', style={"float": "left", "justifyContent": "left"}),
                                ...
                                html.Br(),
                                html.H6("Set click annotation column and value"),
                                html.Div([
                                ...
                                dcc.Input(id="click-annotation-assignment", type="text", value=None,
                                          placeholder="Click annotation value",
                                          ...
                                          html.Div([
                                              ...
                                              dbc.Button(
                                                  ...
                                                  style={"float": "center", "margin-top": "15px",
                                                    ...
                                                    "justifyContent": "center"}),
                                html.Br(),
                                html.Div([dbc.Button("Re-import annotations into quant",
                                id="quant-annot-reimport", style={"background-color": DEFAULT_WIDGET_COLOUR,
                                "margin-left": "10px"}, size='sm')],
                                style={"display": "flex", "justifyContent": "center"}),
                                          dbc.Tooltip(TOOLTIPS['annot-reimport'], target="quant-annot-reimport"),
                                dbc.Modal(children=dbc.ModalBody(
                                [dbc.Row([dbc.Col([html.B("Create a region annotation")], width=8),
                                          dbc.Col([html.B("Set annotation cat & value")], width=4)]),
                                ...
                                html.Br(),
                                dbc.Row([dbc.Col([html.B("Title (PDF export only)")], width=4),
                                          dbc.Col([html.B("Description (PDF export only)")], width=4),
                                          dbc.Col([html.B("Value (required)")], width=4)]),
                                 dbc.Row([dbc.Col([dcc.Input(id="region-annotation-name", type="text",
                                value="", placeholder="Add annotation title",
                                style={"width": "100%", "margin-right": "10px"})], width=4),
                                          dbc.Col([dcc.Input(id="region-annotation-body", type="text",
                                value="", placeholder="Add annotation description",
                                          style={"width": "100%", "margin-right": "10px"})], width=4),
                                          dbc.Col([dcc.Input(id="region-annotation-cell-types", type="text",
                                value="", placeholder="Annotation value/type (required)", style={"width": "100%", "margin-right": "10px",
                                    "height": "100%"})], width=4)]),
                                html.H6("Note: a mask needs to be applied to capture object IDs in the annotation",
                                ...
                                dcc.Checklist(id="bulk-annotate-shapes", value=[],
                                    ...
                                    style={"accent-color": DEFAULT_WIDGET_COLOUR, "width": "25%"}),
                                dbc.Tooltip(TOOLTIPS['region-annotate-all'], target="bulk-annotate-shapes"),
                                ...
                                text='Import mask overlay annotations',
                                ...
                                style={"margin-right": "15px", "margin-top": "10px", 'justifyContent': 'center',
                                       'textAlign': "center"}),
                                dcc.RadioItems([{'label': 'Mask', 'value': 'mask'},
                                        {'label': 'Circles', 'value': 'circles'}], 'mask', id='cluster-annotation-type',
                                style={"margin-top": "7.5px", "margin-left": "15px", 'float': 'center',
                                'justifyContent': 'center', "accent-color": DEFAULT_WIDGET_COLOUR, 'width': '25%'},
                                labelStyle={'display': 'flex', 'alignItems': 'center', 'gap': '4px'}),
                                daq.ToggleSwitch(label='Overlay in legend',
                                ...
                                html.Div([
                                    dcc.Dropdown(id='cluster-col', options=[], multi=False,
                                                 placeholder='Select overlay category',
                                                 style={"width": "100%", "float": "center", 'margin-top': '2px'}),
                                    dbc.Button("Category distribution", id="toggle-cluster-dist",
                                               style={"background-color": DEFAULT_WIDGET_COLOUR,
                                                      "margin-left": '5px'}),
                                ], style={"display": "flex", "float": "center"}),
                                html.Br(),
                                dbc.Row(children=[
                                    dbc.Col(width=6, children=[
                                        dcc.Dropdown(id='cluster-label-list', multi=False, options=[],
                                                     ...
                                                     placeholder='Change overlay colors'),
                                        html.Br(),
                                        ...
                                        dcc.Dropdown(id='cluster-label-selection', multi=True, options=[],
                                                     placeholder='Overlay variables',
                                                     style={'width': '100%',
                                                            'margin-top': '15px'}),
                                    ], style={"display": "inline-block"}),
                                    dbc.Col(width=6, children=[
                                        daq.ColorPicker(id="cluster-color-picker", label="Current variable color",
                                        value=dict(hex="#00ABFC", rgb=None), size=150, style={"margin-top": '2px'})
                                    ])
                                ]),
                                html.Br(),
                                dbc.Button("Show overlay variable labels", id="toggle-cluster-labels",
            ...
            dbc.Tab(label="Channel gallery", tab_id='gallery-tab', id='gallery-tab',
                    label_style={"color": DEFAULT_WIDGET_COLOUR},
                        children=[
                            html.Div([daq.ToggleSwitch(label='Update tiles on canvas zoom',
                        id='toggle-gallery-zoom', labelPosition='bottom', color=DEFAULT_WIDGET_COLOUR,
                                style={"margin-right": "15px", "margin-top": "10px", "textAlign": "center", "width": "10%"}),
                                      dbc.Button("Update tiles", id="chan-gallery-zoom-update",
                                                 className="mb-3", color='dark', n_clicks=0, outline=True,
                                    ...
                                    dbc.Row(dbc.Col(width=12, children=[
                                        html.Div([
                                        html.B("View channel across all ROIs"),
                                        ...
                                        html.Div([
                                            dbc.Button(
                                                ...
                                                className="mb-3", color=None, n_clicks=0,
                                                style={"width": "5%", "margin-top": "0px", "align": "left",
                                                       "float": "left", "justifyContent": "left", "display": "flex",
                                                       "textAlign": "left"}),
                                        ], {"display": "inline-block", "align": "left", "float": "left",
                                                  "textAlign": "left", "margin": "0px", "width": "5%"}),
            ...
            dbc.Tab(label="Panel", tab_id='panel-tab', label_style={"color": DEFAULT_WIDGET_COLOUR},
                    children=
                        ...
                        dash_table.DataTable(id='imc-panel-editable', columns=[], data=None,
                                            editable=True, page_size=250)]), width=9),
                        html.Br(),
                        dbc.Col(html.Div([
                        html.Br()]),
                            width=3)])])]),
                          dbc.Tab(label="Quantification", tab_id='quantification-tab',
                                ...
                                style={"display": "flex", "margin-bottom": "-15px", "justifyContent": "center"}),
                                    ...
                                    yaxis=YAxis(showticklabels=False), margin=dict(l=5, r=0, b=15,
                                    t=20, pad=0))}, responsive=False, config={'displaylogo': False},
                                    style={"height": "100%", "width": "100%", "margin-right": "10px", "display": "flex"}),
                                    html.Br(),
                                    dbc.Button(children=html.Span([html.I(className="fa-regular fa-chart-bar",
                                    style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                                    html.Div("Subset channels for analysis (UMAP, classifiers)")],
                                    ...
                                    html.B("Select channels for the expression plot,"
                                           " UMAP rendering, and running classifiers"),
                                    ...
                                    dbc.Button(children=html.Span([html.I(className="fa-regular fa-chart-bar",
                                    style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                                    html.Div("Classifiers")], style={"display": "flex",
                                    "margin-top": "-5px", "margin-left": "15px", "float": "right"}),
                                    ...
                                    html.Div([
                                        ...
                                        dbc.Tooltip(TOOLTIPS['umap_min_dist'], target="umap-min-dist-label", placement='left'),
                                        ...
                                        style={"width": "52.5%", "margin-right": "10px",
                                               "margin-top": "5px"}),
                                        ...
                                        html.Br(),
                                        html.Div([
                                        html.H6("Min objects for query", id='obj-min-header'),
                                        dbc.Tooltip(TOOLTIPS['query-obj-min'], target="obj-min-header", placement='left'),
                                        html.Br(),
                                    ...
                                    dbc.Modal(children=dbc.ModalBody([html.Div([
                                    html.B("Choose a model to classify objects", style={"float": "left"}),
                                    html.Br(),
                                    dcc.Dropdown(id='plugin-mode', options=PluginDescriptors.descriptors,
                                                 placeholder='Choose object model'),
                                    html.Br(),
                                    html.B("Choose model input column", style={"float": "left"}),
            ...
            dbc.Tab(label='Metadata', tab_id='custom-metadata', label_style={"color": DEFAULT_WIDGET_COLOUR},
                ...
                html.B("Metadata associations", style={"margin-top": "10px", "margin-left": "7.5px"}),
                    ...
                    html.Div([
                        dcc.Dropdown(options=[], value=None, id='meta-x-axis', style={"width": "100%"}, multi=False,
                                     placeholder='Set x-axis variable'),
                    ], style={"width": "60%", "margin": "5px"}),
                        html.Div([
                            dcc.Dropdown(options=[], value=None, id='meta-y-axis', style={"width": "100%"}, multi=False,
                                         placeholder='Set y-axis variable'),
                        ], style={"width": "60%", "margin": "5px"}),
                        html.Div([
                            dcc.Dropdown(options=[], value=None, id='meta-grouping', style={"width": "100%"},
                                         multi=False, placeholder='Set grouping variable'),
                        ], style={"width": "60%", "margin": "5px"}),
                    ], width=9, style={"display": "flex"})),
                    html.Br(),
        ...
        wrap_child_in_loading(dcc.Store(id="session_config"), wrap=config['use_loading']),
        ...
        dcc.Store(id='wsi-transformation-matrix-cache'),
