            ...
            children=[
                ...
                html.Div([
                    html.A("Documentation", id='rakaia-documentation',
                             href='https://camlab-bioml.github.io/rakaia-doc/docs/installation', target="_blank",
                    ...
                    dbc.Offcanvas(
                        ...
                        children=[
                                ...
                                text='Choose or drop imaging/spatial data files',
                                    ...
                                    placeholder="Read files/directory from path (local runs only)",
                                    ...
                                    html.Div([html.Span([
                                        ...
                                        du.Upload(id='upload-param-json', max_file_size=1000,
                                                  filetypes=['json'],
                                                  text='Choose or drop blend/session parameters (JSON)',
                                        ...
                                        dbc.Collapse([
                                            ...
                                            du.Upload(id='upload-custom-metadata', max_file_size=10000,
                                                      text='Choose or drop image-level metadata (CSV)',
                                                      chunk_size=100, max_total_size=10000, max_files=1,
                                                      filetypes=['csv'],
                                                      default_style={"line-height": "5vh", "min-height": "7vh",
                                                                     "max-height": "7vh", "vertical-align": "top",
                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                        ...
                        dbc.Col([
                            ...
                            active_tab='channel-config-tab'),
                                ...
                                dbc.Tabs(id='config-subtabs', children=[
                                    ...
                                    children=[
                                        ...
                                        html.Div(
                                            ...
                                            style={"display": "flex"}, hidden=True),
                                        html.Br(),
                                ...
                                html.B('Pixel values',
                                style={"float": "left", "justifyContent": "left"}),
                                daq.ToggleSwitch(label='Enable pixel values on click',
                                id='enable_click_pix_val', labelPosition='bottom', value=False,
                                color=DEFAULT_WIDGET_COLOUR,
                                style={"width": "45%", "margin-left": "17.5px",
                                "float": "right", "justifyContent": "right", "textAlign": "center"}),
                                ], style={"display": "flex", "width": "100%"}),
                                html.Div(style={"height": "100%", "width": "100%",
                                "textAlign": "center", "display": "inline-block", "float": "center",
                                "justifyContent": "center"}, id="click-hover-shower"),
                                html.Br(),
                                html.Br(),
                                html.Div([
