    ...
    return html.Div(id='rakaia-main', children=[
        ...
        html.Header(
            ...
            html.Div([dcc.Dropdown(id='data-collection', multi=False, options=[],
                ...
                persisted_props = ['value'], persistence_type='session'),
                ...
                children=[
                    ...
                    html.Div([dbc.Row([dbc.Col(html.Div([
                                        ...
                                        width=10),
                                         ...
                                         dbc.Modal(children=dbc.ModalBody(
                                            ...
                                            placeholder='Select WSI', style={'justifyContent': 'left', 'white-space':'initial',
                                                    ...
                                                    persistence=config['persistence'], persisted_props=['value'],
                                            ...
                                            dbc.Button(children=html.Span(
                                              ...
                                              style={'justifyContent': 'left', 'white-space': 'initial', 'overflow-wrap':
                                                  'anywhere', 'textAlign': 'left'}, persistence=config['persistence'],
                                                persisted_props=['value'], persistence_type='session'),
                        ...
                        dbc.Col([
                            ...
                            dcc.Loading(dcc.Dropdown(placeholder="Select stitched image to modify", multi=False, options = [],
                            style={"margin": "5px"}, id='stitch-image-select', persistence=config['persistence'],
                            persisted_props=['value'], persistence_type='session'), type="default",
                                        fullscreen=False, color=DEFAULT_WIDGET_COLOUR),
                            dbc.Button(children=html.Span([html.I(className="fa-solid fa-arrows-to-circle",
                            style={"display": "inline-block", "margin-right": "7.5px", "margin-top": "3px"}),
                            ...
                            html.Br(),
                            html.Br(),
                            wrap_child_in_loading(dcc.Store(id='stitched_images', storage_type="session"), fullscreen=False,
        ...
        dcc.Store(id="uploaded_dict", storage_type="session"),
        ...
        dcc.Store(id="umap-projection", storage_type="session"),
        dcc.Store(id="umap_upload_paths"),
        dcc.Store(id="annotations-dict", storage_type="session"),
        ...
        dcc.Store(id='roi-selection-persistent', storage_type="session"),
        dcc.Store(id='chan-selection-persistent', storage_type="session"),
        ...
        dcc.Store(id='image-blend-cache', storage_type="session"),
        dcc.Store(id='mask-fill-cache', storage_type="session"),
