                                    ...
                                    html.Div([html.Span([
                                        ...
                                        dbc.Collapse([
                                            ...
                                            du.Upload(id='upload-point-annotations', max_file_size=5000, max_files=1,
                                                      text='Import point/click annotations (CSV) as circles',
