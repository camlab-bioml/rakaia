    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        dash_app = DashProxy(__name__,
                        ...
                        external_stylesheets=[dbc.themes.BOOTSTRAP, dbc.icons.FONT_AWESOME,
                                              "https://cdn.jsdelivr.net/npm/@annotorious/openseadragon@latest/dist/annotorious-openseadragon.css"],
                        server=server,
                        assets_folder="assets",
                        external_scripts=["https://cdn.jsdelivr.net/npm/openseadragon@5.0/build/openseadragon/openseadragon.min.js",
                                          "https://cdn.jsdelivr.net/npm/@annotorious/openseadragon@latest/dist/annotorious-openseadragon.js"],
