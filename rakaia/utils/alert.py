...
class ToolTips(BaseModel):
    ...
    tooltips: dict = {"delimiter": "Set a custom delimiter for the string representation of datasets. "
                      ...
                      "cur-roi-slide-parse": "If the current ROI is from an MCD or CosMX file, parse to get the corresponding slide dimensions (width, height). "
                                             "Can be used to create a new stitched image corresponding to the underlying slide.",
                      "cur-roi-stitch-parse": "If the current ROI is from an MCD or CosMX file, parse to get the top-left anchor coordinate. Can be used"
