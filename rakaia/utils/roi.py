...
def dict_of_roi_cell_ids(measurements, sample_col="sample", cell_id_col="cell_id"):
    """
    ...
    sample_col = sample_col if sample_col in measurements.columns else "description"
