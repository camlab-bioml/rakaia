...
def test_annotation_preview_table(annotation_hash):
    ...
    preview_table, columns = annotation_preview_table(annotation_hash, 'Patient1+++slide0+++pos1_1')
    ...
    assert len(preview_frame) == len(annotation_hash['Patient1+++slide0+++pos1_1'].keys()) - 1
