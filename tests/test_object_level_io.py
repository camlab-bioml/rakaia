...
from rakaia.io.annotation import (
    AnnotationRegionWriter,
    AnnotationMaskWriter,
    export_point_annotations_as_csv)

def test_output_annotations_masks(annotation_hash_filtered):
...
def test_output_region_writer(get_current_dir):
    annotation_dict = annotations_dict = {'Patient1+++slide0+++pos1_1': {(('xaxis.range[0]', 384.3802395209581),
            ...
            'M97.85329341317365,422.55389221556885L114.02095808383234,431.53592814371257L'
            '136.47604790419163,456.685628742515L164.32035928143713,500.69760479041923L168.811377245509,'
            '514.1706586826348L167.9131736526946,533.9311377245509L159.82934131736528,541.116766467066L'
            '127.4940119760479,542.9131736526947L113.12275449101796,538.4221556886229L'
            '90.66766467065868,524.0508982035929L61.026946107784426,500.69760479041923L40.368263473053894,'
            '470.1586826347306L34.97904191616767,453.0928143712575L34.97904191616767,434.2305389221557L'
            '53.84131736526947,423.45209580838326L54.73952095808384,423.45209580838326Z': {
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        region_writer = AnnotationRegionWriter(annotation_dict, 'Patient1+++slide0+++pos1_1', mask_dict)
