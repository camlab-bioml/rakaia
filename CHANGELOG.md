...
- Prototype: query WSI zoomed patches on [TCGA UNI](https://huggingface.co/datasets/W8Yi/tcga-wsi-uni2h-features) embeddings
...
- Skip any corrupted files on ROI gallery generation

### Removed

- `update_poetry` bash script
